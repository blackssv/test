...
<tr>
	<td align="right" width="40%"><span><?= GetMessage("BPSNMA_GENERATEICSFILE") ?>:</span></td>
	<td width="60%">
		<?=CBPDocument::ShowParameterField("string", 'GenerateICSFile', $arCurrentValues['GenerateICSFile'], Array('size'=> 50))?>
	</td>
</tr>
<tr>
	<td align="right" width="40%"><span><?= GetMessage("BPSNMA_ICSFILE") ?>:</span></td>
	<td width="60%">
		<?=CBPDocument::ShowParameterField("string", 'ICSFile', $arCurrentValues['ICSFile'], Array('size'=> 50))?>
	</td>
</tr>